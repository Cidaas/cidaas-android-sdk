...
CidaasVerification cidaasNative = CidaasNative.getInstance(your_Activity_Context);

or

CidaasVerification cidaasVerification = new CidaasVerification(Your_Application_Context);
