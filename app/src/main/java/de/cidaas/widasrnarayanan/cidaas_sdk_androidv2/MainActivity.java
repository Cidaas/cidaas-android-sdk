...
import de.cidaas.sdk.android.cidaas.Interface.ILoader;
...
import de.cidaas.sdk.android.cidaasfacebook.CidaasFacebook;
import de.cidaas.sdk.android.cidaasgoogle.CidaasGoogle;
import de.cidaas.sdk.android.cidaasVerification.View.CidaasVerification;
...
public class MainActivity extends AppCompatActivity implements ILoader {
    ...
    public void openAlertFinger(View view) {
        /*de.cidaas.callFingerPrint(this, null, new Result<String>() {
            @Override
    ...
    public void loginWithSocial(View view) {
        try {
         ...
         /*   de.cidaas.getRequestId(new Result<AuthRequestResponseEntity>() {
                @Override
                public void success(AuthRequestResponseEntity result) {
                    de.cidaas.loginWithSocial(this,"linkedin","#009900", new Result<AccessTokenEntity>() {
                        @Override
                        public void success(AccessTokenEntity result) {
                            Toast.makeText(MainActivity.this, "Access Token"+result.getAccess_token(), Toast.LENGTH_SHORT).show();
    ...
    public void getClientInfo(View view) {
     ...
     /*   cidaasNative.getRequestId(new Result<AuthRequestResponseEntity>() {
            //de.cidaas.getRequestId(obj,new Result<String>() {
            @Override
...
*/
    ...
    public void getTenantInfo(View view) {
       ...
       /* cidaasNative.getTenantInfo(new Result<TenantInfoEntity>() {
        ...
        loginEntity.setPassword("2716");
        loginEntity.setUsername("raja.narayanan@widas.in");
        loginEntity.setUsername_type("email");
        CidaasNative.getInstance(this).loginWithCredentials(loginEntity, new Result<LoginCredentialsResponseEntity>() {
            @Override
       ...
       /* ChangePasswordRequestEntity changePasswordRequestEntity=new ChangePasswordRequestEntity();
        changePasswordRequestEntity.setAccess_token("");
        changePasswordRequestEntity.setConfirm_password("");
        changePasswordRequestEntity.setIdentityId("");
        changePasswordRequestEntity.setNew_password(null);
        changePasswordRequestEntity.setOld_password(null);
    ...
    public void passwordlessSmartpush(View view) {
        /*de.cidaas.loginWithSmartPush("raja.narayanan@widas.in", "", "", requestId, null, UsageType.PASSWORDLESS, new Result<LoginCredentialsResponseEntity>() {
            @Override
            public void success(LoginCredentialsResponseEntity result) {
                Toast.makeText(MainActivity.this, ""+result.getData().getAccess_token(), Toast.LENGTH_SHORT).show();
            }
          ...
          /*  de.cidaas.configureFingerprint(MainActivity.this,"sub","",null, new Result<EnrollFingerprintMFAResponseEntity>() {
            @Override
    ...
    public void documentScanner(View view) {
        //  de.cidaas.startDocumentScanner(this);
