    ...
    public void loginButtonFunction(View view)
    {
        ...
        de.cidaas.getRequestId(new Result<AuthRequestResponseEntity>() {
            ...
            public void success(final AuthRequestResponseEntity requestIdresult) {
                ...
                de.cidaas.loginWithCredentials(requestIdresult.getData().getRequestId(), loginEntity,new Result<LoginCredentialsResponseEntity>() {
                    @Override
                    ...
                    public void failure(WebAuthError error) {
                      ...
                      */
/*      de.cidaas.getConsentDetails(consentName, new Result<ConsentDetailsResultEntity>() {
                                @Override
                            ...
                            de.cidaas.getConsentURL(consentName, consentVersion, new Result<String>() {
                                @Override
...
*//*
                           ...
                           de.cidaas.initiateEmailVerification(sub, requestIdresult.getData().getRequestId(), new Result<RegisterUserAccountInitiateResponseEntity>() {
                               @Override
