package de.cidaas.widasrnarayanan.cidaas_sdk_androidv2.EnrollMFA;
...
/*
    ...
    public void onClickButton(View view) {
        ...
        cidaasNative.getRequestId(new Result<AuthRequestResponseEntity>() {
            ...
            public void success(AuthRequestResponseEntity result) {
               ...
               /* de.cidaas.loginWithFaceRecognition(convertImageJpeg(bitmap), passwordlessEntity, new Result<LoginCredentialsResponseEntity>() {
                    @Override
  ...
  /*  @NonNull
    ...
    public File convertImageJpeg(Bitmap bitmap) {
        ...
        try {
            ...
            if (imageFile == null) {
                ...
                imageFile.createNewFile();
                // imageFile=new File(Environment.(), "Cidaas-Faces/de.cidaas.png");
            }
    ...
    private File file() throws IOException {
        ...
        imageFile = new File(pictureFileDir, "de.cidaas.png");
        if (imageFile.exists()) {
            imageFile.delete();
        }
        imageFile.createNewFile();
