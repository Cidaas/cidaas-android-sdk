...
/*   ConsentEntity consentAcceptRequestEntity=new ConsentEntity(consentName,version,sub,trackid,true);
       ...
       */
/*  de.cidaas.loginAfterConsent(consentAcceptRequestEntity, new Result<LoginCredentialsResponseEntity>() {
             @Override
             public void success(LoginCredentialsResponseEntity result) {
...
/*  ResumeConsentRequestEntity resumeConsentRequestEntity=new ResumeConsentRequestEntity();
                 ...
                 de.cidaas.resumeConsent(resumeConsentRequestEntity, new Result<AccessTokenEntity>() {
                     @Override
