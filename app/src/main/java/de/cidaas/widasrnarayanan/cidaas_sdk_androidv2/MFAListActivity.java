...
import InitiateEmailMFAResponseEntity;
import InitiateIVRMFAResponseEntity;
import InitiateSMSMFAResponseEntity;
...
public class MFAListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        de.cidaas.getMFAList(sub, new Result<MFAListResponseEntity>() {
            @Override
    ...
    public void email(View view){
        ...
        de.cidaas.getRequestId(new Result<AuthRequestResponseEntity>() {
            ...
            public void success(AuthRequestResponseEntity result) {
                ...
                de.cidaas.loginWithEmail(passwordlessEntity, new Result<InitiateEmailMFAResponseEntity>()
                {
                    @Override
    ...
    public void sms(View view){
        ...
        de.cidaas.getRequestId(null,new Result<AuthRequestResponseEntity>() {
            ...
            public void success(AuthRequestResponseEntity result) {
                ...
                de.cidaas.loginWithSMS(passwordlessEntity, new Result<InitiateSMSMFAResponseEntity>() {
                    @Override
    ...
    public void ivr(View view){
        ...
        de.cidaas.loginWithIVR(passwordlessEntity, new Result<InitiateIVRMFAResponseEntity>() {
            @Override
            ...
            public void success(AuthRequestResponseEntity result) {
                ...
                de.cidaas.loginWithEmail(passwordlessEntity, new Result<InitiateEmailMFAResponseEntity>()
                {
                    ...
                    public void success(InitiateEmailMFAResponseEntity result) {
                        ...
                        de.cidaas.verifyEmail(code,result.getData().getStatusId(), new Result<LoginCredentialsResponseEntity>() {
                            @Override
                            public void success(LoginCredentialsResponseEntity result) {
...
/*     de.cidaas.getmfaList(sub, new Result<MFAListResponseEntity>() {
            ...
            public void success(MFAListResponseEntity result) {
                ...
                de.cidaas.initiateBackupCodeMFA(physicalVerificationEntity, new Result<InitiateBackupCodeMFAResponseEntity>() {
                    @Override
...
/*     de.cidaas.getmfaList(sub, new Result<MFAListResponseEntity>() {
            ...
            public void success(MFAListResponseEntity result) {
                ...
                de.cidaas.initiateEmailMFA(physicalVerificationEntity, new Result<InitiateEmailMFAResponseEntity>() {
                    @Override
                    public void success(InitiateEmailMFAResponseEntity result) {
                        Intent intent=new Intent(MFAListActivity.this,EmailMFAActivity.class);
                        intent.putExtra("statusId",result.getData().getStatusId());
...
/*   de.cidaas.getmfaList(sub, new Result<MFAListResponseEntity>() {
            ...
            public void success(MFAListResponseEntity result) {
                ...
                de.cidaas.initiateTOTP(physicalVerificationEntity, new Result<InitiateTOTPMFAResponseEntity>() {
                    @Override
...
/*     de.cidaas.getmfaList(sub, new Result<MFAListResponseEntity>() {
            ...
            public void success(MFAListResponseEntity result) {
                ...
                de.cidaas.initiateIVRMFA(physicalVerificationEntity, new Result<InitiateIVRMFAResponseEntity>() {
                    @Override
                    public void success(InitiateIVRMFAResponseEntity result) {
                        Intent intent=new Intent(MFAListActivity.this,IVRMFAActivity.class);
                        intent.putExtra("statusId",result.getData().getStatusId());
