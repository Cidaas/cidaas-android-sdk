...
public class IVRMFAActivity extends AppCompatActivity {
    ...
    public void ivrVerifyCode(View view){
        ...
        de.cidaas.verifyIVR(verificationCode,statusId ,new Result<LoginCredentialsResponseEntity>() {
            @Override
       ...
       */
/* de.cidaas.loginWithIVR(statusId, verificationCode, new Result<AuthenticateIVRResponseEntity>() {
            @Override
