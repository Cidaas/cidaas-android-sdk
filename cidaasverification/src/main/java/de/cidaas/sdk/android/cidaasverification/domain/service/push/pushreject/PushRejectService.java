...
public class PushRejectService {
    ...
    public void callPushRejectService(@NonNull String pushRejectURL, Map<String, String> headers, PushRejectEntity pushRejectEntity,
        ...
        try {
            ...
            pushRejectCallback.failure(WebAuthError.getShared(context).methodException(VerificationConstants.ERROR_LOGGING_PREFIX + methodName, WebAuthErrorCode.PUSH_REJECT_FAILURE,
                    e.getMessage()));
        }
    }
}
