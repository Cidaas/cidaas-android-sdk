...
public class EmailVerificationServiceTest {
    ...
    public void testEnrollEmailMFA() throws Exception {
        ...
        emailVerificationService.enrollEmailMFA("baseurl", "accessToken", null, new Result<EnrollEmailMFAResponseEntity>() {
            @Override
    ...
    public void testInitiateEmailMFA() throws Exception {
        ...
        emailVerificationService.initiateEmailMFA("baseurl", null, new Result<InitiateEmailMFAResponseEntity>() {
            @Override
    ...
    public void testAuthenticateEmailMFA() throws Exception {
        ...
        emailVerificationService.authenticateEmailMFA("baseurl", null, new Result<AuthenticateEmailResponseEntity>() {
            @Override
