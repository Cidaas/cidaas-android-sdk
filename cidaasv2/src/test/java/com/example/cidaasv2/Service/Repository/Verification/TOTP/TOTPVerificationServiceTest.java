...
public class TOTPVerificationServiceTest {
    ...
    public void testSetupTOTP() throws Exception {
        ...
        tOTPVerificationService.setupTOTP("baseurl", "accessToken", "codeChallenge", null, new Result<SetupTOTPMFAResponseEntity>() {
            @Override
    ...
    public void testEnrollTOTP() throws Exception {
               tOTPVerificationService.enrollTOTP("baseurl", "accessToken", null, new Result<EnrollTOTPMFAResponseEntity>() {
                   @Override
    ...
    public void testInitiateTOTP() throws Exception {
        ...
        tOTPVerificationService.initiateTOTP("baseurl", "codeChallenge", null, new Result<InitiateTOTPMFAResponseEntity>() {
            @Override
    ...
    public void testAuthenticateTOTP() throws Exception {
        ...
        tOTPVerificationService.authenticateTOTP("baseurl", null, new Result<AuthenticateTOTPResponseEntity>() {
            @Override
