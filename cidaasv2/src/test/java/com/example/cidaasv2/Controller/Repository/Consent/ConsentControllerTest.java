...
public class ConsentControllerTest {
 /**
  // TODO move to cidaasconsentv2 https://gitlab.widas.de/cidaas-public-devkits/cidaas-public-devkit-documentation/-/issues/52
  ...
  @Test public void testAcceptConsentValue() throws Exception {
  ...
  @Override public void success(LoginCredentialsResponseEntity result) {
