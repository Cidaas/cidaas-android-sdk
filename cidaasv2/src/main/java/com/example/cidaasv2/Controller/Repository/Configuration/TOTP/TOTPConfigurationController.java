    ...
    public void enrollTOTP(@NonNull final String baseurl, @NonNull final String accessToken,
        ...
        try {
            ...
            if (baseurl != null && !baseurl.equals("") && accessToken != null && !accessToken.equals("")) {
                ...
                if (isNotEmpty(enrollTOTPMFARequestEntity.getUserDeviceId()) &&
                        isNotEmpty(enrollTOTPMFARequestEntity.getStatusId()) &&
                        isNotEmpty(enrollTOTPMFARequestEntity.getClient_id()) &&
                        isNotEmpty(enrollTOTPMFARequestEntity.getVerifierPassword())) {
