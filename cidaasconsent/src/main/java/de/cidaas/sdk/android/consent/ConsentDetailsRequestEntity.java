...
public class ConsentDetailsRequestEntity implements Serializable {
    ...
    public ConsentDetailsRequestEntity(String sub, String requestId, String track_id, String consent_id, String consent_version_id) {
        this.sub = sub;
    ...
    public ConsentDetailsRequestEntity(String sub, String requestId, String track_id, String consent_id, String consent_version_id, String client_id) {
