...
public class ClientServiceTestCall {
    ...
    public void testWebClient() throws Exception {
        ...
        try {
            ...
            clientService.getClientInfo("requestId", removeLastChar(CidaasHelper.baseurl), new EventResult<ClientInfoEntity>() {
                @Override
    ...
    public void testWebClients() throws Exception {
        ...
        try {
            ...
            clientService.getClientInfo("req", "localhost:2007", new EventResult<ClientInfoEntity>() {
                @Override
                public void success(ClientInfoEntity result) {
