...
public class ChangePasswordServiceCall {
    ...
    public void testWebClient() throws Exception {
        ...
        try {
            ...
            changePasswordService.changePassword(changePasswordRequestEntity, StringUtils.chop(CidaasHelper.baseurl), deviceInfoEntity, new EventResult<ChangePasswordResponseEntity>() {
                @Override
    ...
    public void testWebClientThrowException() throws Exception {
        ...
        try {
            ...
            changePasswordService.changePassword(changePasswordRequestEntity, StringUtils.chop(CidaasHelper.baseurl), null, new EventResult<ChangePasswordResponseEntity>() {
                @Override
                public void success(ChangePasswordResponseEntity result) {
